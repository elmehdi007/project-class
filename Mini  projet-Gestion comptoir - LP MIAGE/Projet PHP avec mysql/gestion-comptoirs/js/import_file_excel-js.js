$.fn.dragAndDrop = function(p){
  var parameters = {
    'supported' : ['audio/wav','audio/mp3','application/vnd.ms-excel','application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'],
    'size' : 5,
    'uploadFile' : './controller/import_file_excel.php',
...
$('#dnd').dragAndDrop({
  'done' : function(msg){
    ...
    $('#dnd .done').show();
    document.getElementById("div-result-upload-file").innerHTML='<label>'+msg+'</label>';
        console.log(msg);
  }, 
  'error' : function(){
